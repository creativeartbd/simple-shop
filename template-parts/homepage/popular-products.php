<?php if( get_theme_mod( 'simpleshop_display_homepage_popular_product', true ) ) : ?> 
<section class="space-3">
    <div class="container">
        <div class="row justify-content-md-center">
            <div class="col-md-8">
                <div class="section-title text-center">
                    <h2 class="title "><?php echo get_theme_mod( 'simpleshop_display_homepage_popular_product_title' ); ?></h2>
